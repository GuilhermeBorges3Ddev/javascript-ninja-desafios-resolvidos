(function(doc){
   ...
   * Já o atributo ".nextSibling" pega o primeiro irmão após o nó consultado na DOM(caso não exista, null).
   * E o atributo ".previousSibling" retorna o primeiro irmão antes do nó consultado, caso não haja, retorna 'null'; tal e qual a propriedade anterior.
  */
