...
(function(){
    ...
    */
    ...
    var cpfList = ['049-214 342-11', '210.458.522-05', '735 500 794 - 22', '101.123-131x32'];
    
    function cleanCPF(cpfArg) {
       return cpfArg.replace(/\D/g, '')
    }

    cpfList.forEach(function(cpfItem){
        console.log("CPF " + cpfItem + " convertido para: ", cleanCPF(cpfItem));
    });
    ...
    */
    ...
    cpfList.forEach(function(cpfItem){
        console.log("CPF " + cpfItem + " limpo e formatado: ", cleanCPF(cpfItem).replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, '$1.$2.$3-$4'));
    });
    ...
    */
    ...
    var fraseComTags = "<div><section><blockquote>Texto <img /></blockquote></section></div>";
   
    console.log("\n" + fraseComTags.match(/<\w+>/g));
    ...
    */
    ...
    var apenasTags = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";

    console.log(apenasTags.match(/<\w+><\/\w+>/g));
    ...
    */
    ...
    var textosMarcacoesRegex = /<(\w+)>([^<]+)<\/\w+>/g;

    var marcacaoParaReplace = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";

    console.log(
        marcacaoParaReplace.replace(
            textosMarcacoesRegex,
