(function(win){
  ...
  */
  ...
  function sum() {
    ...
    var result  = Array.prototype.reduce.call(arguments, function(ac, item) {
      return (+ac) + (+item);
    });
    console.log("Resultado da soma dos parametros:", result, '\n');
  }
  ...
  */
  ...
  function justNumbers(entryString) {
    return entryString.replace(/\D+/gi, ',').split(',');
  }
