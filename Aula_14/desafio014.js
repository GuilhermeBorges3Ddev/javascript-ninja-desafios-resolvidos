...
(function(){
    ...
    */
    console.log( '\nOperation:' );
    var operation = justMod2Or3.reduce(function(ac, i, index){
        return (ac + 1) * i; 
    }, 0);
    ...
    */
    console.log( '\nOperation 2:' );
    var operation2 = justMod2Or3.reduceRight(function(ac, i, index){
        return (ac + 1) * i; 
    }, 0);
    ...
    */
    ...
    var nome = ["Gui", "lher", "me"];
    console.log(nome.reduce(function(ac, i){
        return ac + 'P' + i;
    }), '');
    console.log( '---------------------' );
    ...
    */
    console.log( '\nInversed Name:' );
    var inversedName = nome.reduceRight(function(ac, i){
        return ac + i;
    }, "");
