...
(function () {
    ...
    /*
        ...
        no console:
    */
    console.log( '\nRegex para números usando o construtor:' );
    ...
    */
    ...
    function hasClass(markup, cssClass) {
       var classRegex = new RegExp('class=[\'"](?:[\\w\\s]+)?' + cssClass + '(?:[\\w\\s]+)?[\'"]')
       return classRegex.test(markup)
    }
    var classes = ["container", "text", "date", "excerpt", "main"];
    classes.forEach(function(cssClass){
        console.log(hasClass(markup, cssClass) + ' resultado para a classe ' + cssClass);
    })
