...
(function(){
    ...
    */
    ...
    var regexExpName = /(Manuel Marques de Sousa)/g;
    console.log(text.replace(regexExpName, "Guilherme Silva Borges"));
    console.log("----------------------------------------------");
    ...
    */
    ...
    var regexExpNaturality = /(brasileiro)/g;
    console.log(text.replace(regexExpNaturality, "São Lourenciano"));
    console.log("----------------------------------------------");
    ...
    */
    ...
    function getMonthNumber(month) {
        ...
        return monthItens[month];
    }

    var tresMeses = ["março", "setembro", "dezembro"]
    for(var iterator = 0; iterator < tresMeses.length; iterator++) {
        var monthConverted = getMonthNumber(tresMeses[iterator]);
        console.log("O mês de " + tresMeses[iterator] + " é representado pelo número " + monthConverted + ".");
    }
    console.log("----------------------------------------------");
